...
layout = dbc.Container([
    ...
    #Alert 
    html.Div(dbc.Alert("Las credenciales son incorrectas. Vuelva a intentarlo.", color="danger", id="bad_credentials_alert",is_open=False, duration=10000)),
    ...
    html.Div([
             ...
             html.Div(
                [
                    dbc.Button(
                        "Iniciar sesión", id="submit_button",type="submit", className="me-2 submit_btn margin-top-20", 
                    ),
